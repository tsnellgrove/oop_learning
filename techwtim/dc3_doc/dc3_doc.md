...
TBD: At this point declare v3.10 done (update version, clean up files, truncate to-do)
	...
	TBD: Create old_versions and docs folders and move files to them
	TBD: Update version number to 3.10 in static_dict and comments
	TBD: move 3.10 to-dos to done
	TBD: Commit to git with version 3.10 tag	
